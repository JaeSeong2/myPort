...
function FlowTimelineRow({ row, isLast, onEdit, onDelete }) {
  return (
    <div className="flex gap-4">
      ...
      {/* 오른쪽: 카드 */}
      <div className="flex-1 mb-3 rounded-xl border border-theme bg-surface px-4 py-3 flex items-center gap-3">
